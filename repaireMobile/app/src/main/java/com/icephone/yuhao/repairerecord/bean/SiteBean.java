...
public class SiteBean {
    ...
    public static class DataBean {
        private List<SiteBeanBean> SiteBean;

        public List<SiteBeanBean> getSiteBean() {
            return SiteBean;
        }

        public void setSiteBean(List<SiteBeanBean> SiteBean) {
            this.SiteBean = SiteBean;
        }

        public static class SiteBeanBean {
            /**
