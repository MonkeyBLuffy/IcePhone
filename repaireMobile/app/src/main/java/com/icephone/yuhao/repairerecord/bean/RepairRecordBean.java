...
public class RepairRecordBean implements Serializable {
     ...
     * code : 200
     * msg : 查询成功
     * data : {"repairBean":[{"_id":"5bcc5ea1775c42d5c8480028","time":"20181007","site_name":"南大冉信用社","repair_pro":"电视监控","repair_person":"林雨","site_person":"张三，王五","center_name":"清苑联社","device":"电视监控","fix_state":"摄像机无图像，保修期内进行更换","return_fix":1,"fix_cost":"","return_time":"未返厂"},{"_id":"5bcc5f23775c42d5c848002a","time":"20181007","site_name":"南大冉信用社","repair_pro":"电视监控","repair_person":"林雨","site_person":"张三，王五","center_name":"清苑联社","device":"电视监控","fix_state":"摄像机无图像，保修期内进行更换","return_fix":1,"fix_cost":"","return_time":"未返厂"},{"_id":"5bcc5f1b775c42d5c8480029","time":"20181007","site_name":"南大冉信用社","repair_pro":"电视监控","repair_person":"林雨","site_person":"张三，王五","center_name":"顺平联社","device":"电视监控","fix_state":"摄像机无图像，保修期内进行更换","return_fix":1,"fix_cost":"","return_time":"未返厂"}]}
     */
    ...
    public static class DataBean {
        private List<RepairBeanBean> repairBean;

        public List<RepairBeanBean> getRepairBean() {
            return repairBean;
        }

        public void setRepairBean(List<RepairBeanBean> repairBean) {
            this.repairBean = repairBean;
        }

        public static class RepairBeanBean {
            /**
